-- Stage-2 the enrollment slice (migration 0017, the rules slice / finding the kickstart) — ENROLLMENT-SCOPED sessions.
--
...
--                  stays out of reach, and no long-lived refresh row is ever minted
