...
//   swift run    --package-path apps/macos MailOh          (opens a window)
//   swift run    --package-path apps/macos MailOh --smoke  (offscreen render check)
//
...
let package = Package(
    ...
    targets: [
        .target(
            name: "MailOhKit",
            path: "Sources/MailOhKit",
            swiftSettings: [.swiftLanguageMode(.v5)]
        ),
        .executableTarget(
            name: "MailOh",
            dependencies: ["MailOhKit"],
            path: "Sources/MailOh",
            swiftSettings: [.swiftLanguageMode(.v5)]
        ),
        .testTarget(
