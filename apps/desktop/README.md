...
The version is **`0.7.2`**, bare, in every place it is written: `tauri.conf.json`,
...
the installed `CFBundleVersion` — so a bundle announcing `0.7.2` there would be
...
`CFBundleShortVersionString` is `0.7.2` and is what the app and every download
